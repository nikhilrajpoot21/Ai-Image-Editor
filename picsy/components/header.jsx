...
const Headers = () => {
  ...
  return (
    <header className='fixed top-3 left-1/2 transform -translate-x-1/2 z-50 text-nowrap h-16'>
      <div className='h-full backdrop-blur-md bg-white/20 border border-white/20 rounded-full px-8 py-3 flex items-center justify-between gap-8'>
        ...
        {path == '/' && <div className='hidden md:flex space-x-6'>
          ...
          <div className='text-white flex items-center gap-3 ml-10 md:ml-20'>
            <SignedOut>
              <SignInButton>
